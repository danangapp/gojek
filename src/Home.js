          ...
          <ScrollView style={styles.container1}>
          	<View style={styles.rowS}>
	            <View style={styles.viewS}>
		        	...
		        	<TouchableOpacity onPress={()=>{ini.props.navigation.navigate('Note')}} style={styles.view1}>
			      ...
			      <ScrollView horizontal>
			      	<TouchableOpacity onPress={()=>{ini.props.navigation.navigate('Note')}} style={styles.ban3}>
			      ...
			      <TouchableOpacity onPress={()=>{ini.props.navigation.navigate('Note')}} style={styles.ban4}>
			      ...
			      <TouchableOpacity onPress={()=>{ini.props.navigation.navigate('Note')}} style={styles.ban5}>
